...
//SISO HTMLComposer Start
    void ascentAndDescentForBox(InlineBox*, GlyphOverflowAndFallbackFontsMap&, int& ascent, int& descent, bool& affectsAscent, bool& affectsDescent) ;
...
//SISO HTMLComposer Start
    bool isLineHeightAdjust() const {return m_lineHeightAdjust>0;}
    int lineHeightAdjustValue() const {return m_lineHeightAdjust;}
    bool isThaiReshapeChars() ;
    void setThaiDescentAdjust(int adjustDescent) {m_thaiDescentAdjust = adjustDescent;}
    int thaiDescentAdjust() {return m_thaiDescentAdjust;}
//SISO HTMLComposer End
private:
...
//SISO HTMLComposer Start
    //For Thai, Viet Clipping Issues (FontMetrics not matching with actual dimensions)
    int m_lineHeightAdjust;
    int m_thaiDescentAdjust;
//SISO HTMLComposer End
