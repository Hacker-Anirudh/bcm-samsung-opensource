...
void mmc_rescan(struct work_struct *work)
{
	...
	/*
	 * On Rhea platform, some UHS-1 cards fails to switch to 1.8V
	 * signalling at 100KHz. The SD spec defines 100KHz - 400KHz range
	 * for UHS-1 switch sequence. When programmmed 100KHz, the clock
	 * variations below 100KHz would cause a spec violation, and some
	 * UHS-1 cards fails during voltage switch (CMD6).
