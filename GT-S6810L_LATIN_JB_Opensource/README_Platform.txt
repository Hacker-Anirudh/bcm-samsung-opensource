...
case 10) audio\alsaplugin : should add 'libasound_module_pcm_bcmfilter' to PRODUCT_PACKAGES
case 11) sap : should add 'sap' to PRODUCT_PACKAGES

ex.) [build\target\product\core.mk] - add all module name for case 1 ~ 10 at 
once
