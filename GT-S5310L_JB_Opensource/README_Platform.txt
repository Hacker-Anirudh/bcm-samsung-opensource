...
: version info - Android jellybean 4.1.2_r1
...
case 7) bluetoothtest\bcm_dut : should add 'bcm_dut' to PRODUCT_PACKAGES
case 8) libasound : should add 'libasound' to PRODUCT_PACKAGES
case 9) audio\alsaplugin : should add 'libasound_module_pcm_bcmfilter' to PRODUCT_PACKAGES

ex.) [build\target\product\core.mk] - add all module name for case 1 ~ 9 at 
once
