...
: version info - Android icecreamsandwich 4.0.4
...
case 1) bluetooth : should add 'sap', 'audio.a2dp.default' to PRODUCT_PACKAGES
...
ex.) [build\target\product\core.mk] - add all module name for case 1 ~ 6 at 
once
