...
import com.smlds.base.smlDebug;
import com.smlds.base.smlMimeException;
...
public class smlQP
{
    ...
    public static String encodeQP(String in) throws smlMimeException
    {
        ...
        {
            smlDebug.smlLibPrintException(e.toString());
        }
     ...
     * @exception smlMimeException : if a decoding error occurs.
     ...
     * @return the decoded bytes
     * @exception ParseException : If a '=' is not followed by a valid 2-digit hex number or '\r\n'.
     */
