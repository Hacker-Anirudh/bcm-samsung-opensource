...
#define PMU_REG_RTC_CALIB1	ENC_PMU_REG(FIFO_MODE, MAP1, 0x00F4)

#define PMU_REG_RTC_CALIB2	ENC_PMU_REG(FIFO_MODE, MAP1, 0x00F5)

#define PMU_REG_RTC_CALIB3	ENC_PMU_REG(FIFO_MODE, MAP1, 0x00F6)
