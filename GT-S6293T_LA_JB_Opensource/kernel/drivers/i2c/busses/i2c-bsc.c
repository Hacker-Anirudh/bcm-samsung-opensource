...
#define CMDBUSY_SHORT_DELAY      10


#define SUPPORT_SHORT_TIMEOUT_I2C
#ifdef SUPPORT_SHORT_TIMEOUT_I2C
#define SHORT_TIMEOUT_BSC_ID 0  // BSC I2C ID number
#else
#define SHORT_TIMEOUT_BSC_ID 0xFF
#endif

#define SES_TIMEOUT              (msecs_to_jiffies(100))
#define SES_SHORT_TIMEOUT	(msecs_to_jiffies(10))
			       ...
			       uint8_t *buf, unsigned int len)
{
	...
	for (i = 0 ; i < len/MAX_TX_FIFO_SIZE ; i++) {
		...
		if (dev->adapter.nr == SHORT_TIMEOUT_BSC_ID)
		{
