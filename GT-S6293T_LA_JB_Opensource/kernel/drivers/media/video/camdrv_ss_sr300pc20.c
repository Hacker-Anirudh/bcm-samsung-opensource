	...
	if (state->currentScene == SCENE_MODE_NIGHTSHOT || state->currentScene == SCENE_MODE_FIREWORKS) {
		...
		if(ymean < 0x16 ){
			if (state->currentScene == SCENE_MODE_NIGHTSHOT) {
				...
				err = camdrv_ss_i2c_set_config_register(client, sr300pc20_snapshot_fireworks_regs, ARRAY_SIZE(sr300pc20_snapshot_fireworks_regs), "snapshot_fireworks_regs");
			}
		}
		else{
...
#elif defined(CONFIG_SOC_CAMERA_SR300PC20)
	...
	if(on)
{
		...
		regulator_set_voltage(VCAM_IO_1_8_V,VCAM_IO_1_8V_REGULATOR_uV,VCAM_IO_1_8V_REGULATOR_uV);	
		regulator_set_voltage(VCAM_A_2_8_V,VCAM_A_2_8V_REGULATOR_uV,VCAM_A_2_8V_REGULATOR_uV);		
#if defined(CONFIG_SOC_CAMERA_POWER_USE_ASR) || defined(CONFIG_MFD_D2083) || defined(CONFIG_SOC_CAMERA_SR300PC20)   //for hw rev 0.3
		regulator_set_voltage(VCAM_CORE_1_2_V,VCAM_CORE_1_2V_REGULATOR_uV,VCAM_CORE_1_2V_REGULATOR_uV);
#endif	
...
#if defined(CONFIG_SOC_CAMERA_POWER_USE_ASR) || defined(CONFIG_MFD_D2083) || defined(CONFIG_SOC_CAMERA_SR300PC20)   //for hw rev 0.2		
